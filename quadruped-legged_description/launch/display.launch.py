...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='quadruped-legged_description').find('quadruped-legged_description')
    default_model_path = os.path.join(pkg_share, 'urdf/quadruped-legged.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'config/display.rviz')
    world_path = os.path.join(pkg_share, 'worlds/room.sdf')
    # sdf_path = os.path.join(pkg_share, 'models/urdf/quadruped-legged/model.sdf')
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=['-entity', 'quadruped-legged', '-topic', 'robot_description'],
        parameters=[{'use_sim_time': use_sim_time}],
        output='screen'
    )
