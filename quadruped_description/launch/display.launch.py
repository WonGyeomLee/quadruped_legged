...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='quadruped_description').find('quadruped_description')
    default_model_path = os.path.join(pkg_share, 'urdf/quadruped_macro.urdf.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'config/display.rviz')
    world_path = os.path.join(pkg_share, 'worlds/room.sdf')
    # sdf_path = os.path.join(pkg_share, 'models/urdf/quadruped/model.sdf')
